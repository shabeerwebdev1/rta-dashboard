...
export const whitelistPlateConfig: PageConfig = {
  ...
  searchConfig: {
    globalSearchKeys: ["plateNumber", "plateSource_Id"],
    columnFilterKeys: ["plateSource_Id", "plateType_Id", "plateColor_Id", "plateStatus_Id"],
  ...
  tableConfig: {
    columns: [
      ...
      { key: "plateType_Id", title: "form.plateType", type: "string", filterable: true, lookupCategory: 300 },
      { key: "plateColor_Id", title: "form.plateColor", type: "badge", lookupCategory: 400 },
      { key: "fromDate", title: "form.fromDate", type: "date", sortable: true },
      { key: "toDate", title: "form.toDate", type: "date", sortable: true },
      { key: "plateStatus_Id", title: "form.status", type: "tag", filterable: true, lookupCategory: 500 },
      { key: "exemptionReason_ID", title: "form.exemptionReason", type: "string", lookupCategory: 100 },
