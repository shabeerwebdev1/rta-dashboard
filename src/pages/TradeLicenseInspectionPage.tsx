...
import { tradeLicenseConfig } from "../config/pageConfigs/tradelicenseConfig";
  ...
  return (
    <Space direction="vertical" size="large" style={{ width: "100%" }}>
      ...
      <DataTableWrapper
        ...
        getLabelFromValue={(value, options) => getLabelFromValue(value, options, i18n)}
        columnLookupMap={{ inspectionType: 1800, inspectionCategory: 1300 }} // ✅ Added inspectionCategory
      />
