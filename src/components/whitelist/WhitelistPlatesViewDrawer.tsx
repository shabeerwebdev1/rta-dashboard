...
import React, { useState, useEffect } from "react";
import { Modal, Card, Row, Col, Typography, Button, Empty, Spin, Tag, Space, theme } from "antd";
          ...
          <Col>
            <Space size="middle" align="center">
              <Title level={4} style={{ margin: 0 }}>
                ...
                <Text type="danger">#{(mappedRecord?.plateNumber as string) || "---"}</Text>
              </Title>
            </Space>
          </Col>
          <Col>
            ...
            <Row gutter={16}>
              ...
              <Col span={24}>
                ...
                >
                  <Row gutter={[0, 12]}>
                    <Col span={10}>
                      <Text strong>{t("form.Number")}:</Text>
                    </Col>
                    <Col span={14}>{mappedRecord.plateNumber || t("common.noData")}</Col>

                    <Col span={10}>
                      <Text strong>{t("form.Source")}:</Text>
                    </Col>
                    <Col span={14}>{mappedRecord.plateSource || t("common.noData")}</Col>

                    <Col span={10}>
                      <Text strong>{t("form.Type")}:</Text>
                    </Col>
                    <Col span={14}>{mappedRecord.plateType || t("common.noData")}</Col>

                    <Col span={10}>
                      <Text strong>{t("form.Color")}:</Text>
                    </Col>
                    <Col span={14}>{mappedRecord.plateColor || t("common.noData")}</Col>

                    <Col span={10}>
                      <Text strong>{t("form.status")}:</Text>
                    </Col>
                    <Col span={14}>
                      {mappedRecord.plateStatus
                        ? getStatusTag(mappedRecord.plateStatus.value, mappedRecord.plateStatus.label)
                        : t("common.noData")}
                    </Col>
                    ...
                    <Col span={14}>{mappedRecord.exemptionReason || t("common.noData")}</Col>
                    ...
                    <Col span={14}>{mappedRecord.fromDateFormatted || t("common.noData")}</Col>

                    <Col span={10}>
                      <Text strong>{t("placeholders.endDate")}:</Text>
                    </Col>
                    <Col span={14}>{mappedRecord.toDateFormatted || t("common.noData")}</Col>

                    <Col span={10}>
                      <Text strong>{t("form.violationCategory")}:</Text>
                    </Col>
                    <Col span={14}>{mappedRecord.violationCategoryLabel || t("common.noData")}</Col>
                  </Row>
                </Card>
              </Col>
            </Row>
